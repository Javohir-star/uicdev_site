...
class Order(BaseModel):
    ...
    currency = models.CharField(
        _("currency"), max_length=20, choices=CurrencyEnum.choices
    )
...
class Transaction(BaseModel):
    ...
    vendor = models.CharField(
        _("vendor"), max_length=20, choices=PaymentVendorEnum.choices
    )
    status = models.CharField(
        _("status"), max_length=20, choices=TransactionStatusEnum.choices
    )
    currency = models.CharField(
        _("currency"), max_length=20, choices=CurrencyEnum.choices
    )
